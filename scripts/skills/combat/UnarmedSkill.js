...
import { IRON_ARM_DAMAGE_PER_LEVEL, IRON_ARM_MAX_BONUS, DISARM_CHANCE_PER_LEVEL, ARROW_DEFLECT_CHANCE_PER_LEVEL } from "../../data/SkillConstants.js";
export class UnarmedSkill extends BaseSkill {
    constructor() {
        super(...arguments);
        this.skillType = SkillType.Unarmed;
        this.name = "Unarmed";
    }
