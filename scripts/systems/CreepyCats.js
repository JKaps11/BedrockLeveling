...
export class CreepyCats {
        ...
        for (const player of world.getAllPlayers()) {
            ...
            for (const cat of cats) {
                ...
                if (!tameable || !tameable.tamedToPlayer)
                    continue;
                if (cat.getTags().includes("standing_cat_hidden"))
                    continue;
    ...
    openNearbyDoorByEntity(standingEntityId, dimensionId) {
        try {
