import { Player, Block, BlockPermutation, ItemStack, system } from "@minecraft/server";
...
const REPLANTABLE_CROPS: Record<string, string> = {
...
export class HerbalismSkill extends BaseSkill {
  readonly skillType = SkillType.Herbalism;
  readonly name = "Herbalism";
  ...
  private getCropDrop(blockTypeId: string): string | undefined {
